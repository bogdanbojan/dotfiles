...
return {
    ...
    },
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>dct", require('dap-go').debug_test, { desc = "Debug: Test", silent = true })
...

    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>dus", function() toggle_debug_ui("stacks") end,
                { desc = "Debug: toggle stacks ui" })
            vim.keymap.set("n", "<leader>duw", function() toggle_debug_ui("watches") end,
                { desc = "Debug: toggle watches ui" })
            vim.keymap.set("n", "<leader>dub", function() toggle_debug_ui("breakpoints") end,
                { desc = "Debug: toggle breakpoints ui" })
            vim.keymap.set("n", "<leader>dus", function() toggle_debug_ui("scopes") end,
                { desc = "Debug: toggle scopes ui" })
            vim.keymap.set("n", "<leader>duc", function() toggle_debug_ui("console") end,
